...
import frc.robot.commands.GroundAlgaePickUp;
...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    lights.setDefaultCommand(lights.set(Lights.Special.OFF));   elevator.setDefaultCommand(elevator.idle(this::isArmInsideElevator, sensation::clawCoralPresent).repeatedly());
    ...
    if (DriverStation.isTest()) {
      ...
      copilotXbox.povDown().whileTrue(new GroundAlgaePickUp(elevator, arm));
      copilotXbox.povUp().whileTrue(new ScoreAlgaeNet(elevator, arm));
