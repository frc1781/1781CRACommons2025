...
public class CenterAndScoreL3 extends SequentialCommandGroup {
    ...
    public CenterAndScoreL3(RobotContainer robotContainer, BooleanSupplier strafeLeft) {
